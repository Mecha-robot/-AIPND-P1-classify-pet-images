...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic.keys():
        ...
        # Pet Image Label is a Dog & Labels match
    ...
    # the condition here to prevent divied by zero since the accuracy of the classifier may reach 100% 
